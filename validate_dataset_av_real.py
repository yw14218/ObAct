...
if __name__ == "__main__":
    ...
    try:
        ...
        with mujoco.viewer.launch_passive(
            ...
            # Sample object poses
            with h5py.File("E:\\20250324_211805_v2.h5", "r") as f:
            ...
            try:
                while viewer.is_running():
                    ...
                    action_world = T_left_base_world @ action_left_base
                    action = transform_to_wxyz_xyz(action_world)
                    move_to_pose(data, model, aloha_mink_wrapper, action, rate.dt)
                    step_cnt += 1
